...
<head>
    ...
    <!-- ========================= CSS here ========================= -->
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/bootstrap-5.0.0-beta2.min.css') }}" />
...
<body>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    <div class="hero-image text-center text-lg-end">
                        <img src="{{ asset('frontend/assets/images/hero/hero-image.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 order-last order-lg-first">
                    <div class="about-image">
                        <img src="{{ asset('frontend/assets/images/about/about-image.svg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-feature">
                                ...
                                <div class="feature-content">
                                    <h4>SaaS Focused</h4>
                                    <p>Lorem ipsum dolor amet, consetetur sadipscing elitr, diam nonu eirmod tem
                                        invidunt.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="cta-image text-lg-end">
                        <img src="{{ asset('frontend/assets/images/cta/cta-image.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-10">
                    <div class="footer-widget">
                        <div class="logo">
                            <a href="{{ url('/') }}"> <img src="{{ asset('frontend/assets/images/logo/logo.svg') }}" alt="logo"> </a>
                        </div>
    ...
    <!-- ========================= JS here ========================= -->
    <script src="{{ asset('frontend/assets/js/bootstrap-5.0.0-beta2.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/tiny-slider.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/wow.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/js/polyfill.js') }}"></script>

...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template-dashboard/vendors/datatables.net-bs4/dataTables.bootstrap4.css') }}">
    ...
    <link rel="shortcut icon" href="{{ asset('template-dashboard/images/favicon.png') }}" />
</head>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="{{ url('/') }}">
                <img src="{{ asset('template-dashboard/images/logo.svg') }}" class="mr-2" alt="logo"/>
            </a>
            <a class="navbar-brand brand-logo-mini" href="{{ url('/') }}">
                <img src="{{ asset('template-dashboard/images/logo-mini.svg') }}" alt="logo"/>
            </a>
        </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item nav-profile dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                        <img src="{{ asset('template-dashboard/images/faces/face28.jpg') }}" alt="profile"/>
                    </a>
